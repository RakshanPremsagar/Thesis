...
char *discovery_url = "opc.tcp://localhost:4840";
static void
...
int main(int argc, char **argv) {
    ...
    config->mdnsConfig.mdnsServerName = UA_String_fromChars("Sample Crane Server");
    ...
    int count= getCountValue();
        if(count!=0)
        	...
        	caps[1]=UA_String_fromChars("Starting...");
    ...
    UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_SERVER,
                "Server started. Waiting for announce of LDS-ME Server.");
...
//
//    config->mdnsConfig.mdnsServerName = UA_String_fromChars("Another Sample Multicast Server");
//
//    //setting custom outbound interface
